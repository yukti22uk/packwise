        ...
        {results&&!processing&&(<>
          ...
          <div style={{...S.card,padding:"0",overflow:"hidden"}}>
            ...
            <div style={{overflowX:"auto"}}><table style={{width:"100%",borderCollapse:"collapse",fontSize:"12px"}}>
              ...
              <tbody>{results.slice(0,100).map((r,i)=>r.error?(<tr key={i} style={{background:"#fef2f2"}}><td style={{padding:"8px 12px",fontWeight:"500"}}>{r.name}</td><td style={{padding:"8px 12px",color:"#dc2626"}} colSpan={7}>{r.error}</td></tr>
...
function TwoSKUTool(){
  ...
  return(<div>
    ...
    {result&&(result.total===0?(
      <div style={{...S.card,marginTop:"20px",background:"#fef2f2",border:"1px solid #fecaca"}}>
        <div style={{fontWeight:"600",color:"#dc2626"}}>No valid arrangement found.</div>
...
function ToolPage({isPro,setIsPro,modalOpen,setModalOpen}){
  ...
  const tabs=[["box","📦 Box Packing",false],["twosku","⚖️ Two-SKU Pallet/Container",true],["shipment","🚚 Shipment Planner",true],["sku","🗃️ Container SKU",false]];
  return(
    <div>
      ...
      <div style={{background:"#f0f4f8",minHeight:"60vh",padding:"24px 32px 0"}}>
        <div style={{maxWidth:"1200px",margin:"0 auto"}}>
